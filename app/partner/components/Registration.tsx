            ...
            <div className="container mx-auto px-8 py-8">
                <div className="rounded-lg shadow-lg grid grid-cols-12 bg-white overflow-hidden">
                    <div className="col-span-7 p-8">
                        ...
                        <div>Tulis data diri anda dan tim kami akan segera menghubungi anda.</div>
                        ...
                        <div>Dengan menekan Daftar, maka saya telah menkonfirmasi untuk menyetujui Syarat dan Ketentuan yang berlaku</div>
                        <div>
                            <button>DAFTAR</button>
                        </div>
                    </div>
                    <div className="col-span-5 relative">
                        <img src={`${IMAGE_BASEURL}/images/handshake.png`} alt="partner" className="absolute top-0 left-0 w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
