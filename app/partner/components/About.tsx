    ...
    return (
        <div className="flex-1 space-y-4">
            <div className="flex gap-4 items-center">
                <div className="flex-none p-4 aspect-square bg-white border-2 border-paprika-900 shadow-xl shadow-paprika-900 rounded"><Icon className='text-paprika-900 text-2xl' /></div>
            ...
            <div className="space-y-2">
                ...
                <div className="space-y-4">
                    {partner.benefits.map((c: any, i: number) => (
                        <div className="border-l-4 border-paprika-900 pl-4" key={i}>{c}</div>
                    ))}
                </div>
            </div>
        </div>
        ...
        <div className="bg-white text-black">
            <div className="container mx-auto px-8 py-32 space-y-16">
                <div>
                    ...
                    <div className="font-black text-6.5xl">Bergabunglah Bersama Kami Dan Raih Kesuksesan Bersama</div>
                </div>
                <div className="space-y-8">
                    <div>Master Online memberikan kesempatan kepada Anda untuk menjadi BISNIS PARTNER, dengan 2 jenis Bisnis Partner yg dapat anda pilih:</div>
                    <div className="flex">
                        {PARTNERS.map(c => <Partner key={c.id} partner={c} />)}
                    </div>
                </div>
            </div>
        </div>
